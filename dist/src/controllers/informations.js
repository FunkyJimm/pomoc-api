...
const information_1 = __importDefault(require("../services/information"));
...
const getInformations = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const informations = yield information_1.default.getInformations();
...
const getInformationDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const information = yield information_1.default.getInformationDetails(id);
        return res.status(200).send({
            status: 200,
            data: information,
        });
...
const addInformation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield information_1.default.addInformation(content);
...
const updateInformation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield information_1.default.updateInformation(id, content);
        return res.status(200).send({
            status: 200,
...
const deleteInformation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield information_1.default.deleteInformation(id);
        return res.status(200).send({
            status: 200,
